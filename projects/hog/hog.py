...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    dice:            A function that simulates a single 1 roll outcome.
    """
...
def play(
    ...
    while score0 < goal and score1 < goal:
        ...
        while extra_turn(score0, score1) and score0 < goal:
            ...
            say = say(score0, score1)
        if score0 < goal:
            num_roll2 = strategy1(score1, score0)
            score1 += take_turn(num_roll2, score0, dice)
            say = say(score0, score1)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        myscore = None
        my_running_high = None
        parent_running_high = running_high
        myWho = who
        if myWho == 0:
            my_running_high = score0 - last_score
            myscore = score0
        elif myWho == 1:
            my_running_high = score1 - last_score
            myscore = score1
        else:
            my_running_high = None
        if my_running_high != None and my_running_high > parent_running_high:
            print(my_running_high, "point(s)! The most yet for Player", who)
        if my_running_high < parent_running_high:
            my_running_high = parent_running_high
        return announce_highest(myWho, myscore, my_running_high)
        # if who == 0:
        #     if last_running_high < score0 - last_score:
        #         last_running_high = score0 - last_score
        #         print(last_running_high, " point(s)! The most yet for Player ", who)
        #         return announce_highest(who, score0, last_running_high)
        # elif who == 1:
        #     if last_running_high < score1 - last_score:
        #         last_running_high = score1 - last_score
        #         print(last_running_high, " point(s)! The most yet for Player ", who)
        #         return announce_highest(who, score1, last_running_high)
...
def make_averaged(original_function, trials_count=1000):
    ...
    def averaged_dice(*args):
        result = 0
        my_trials_count = trials_count
        while my_trials_count > 0:
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    "*** YOUR CODE HERE ***"
    number_of_dice = 0
    max_scoring_num_rolls = 10
    highest_average = 0
    while max_scoring_num_rolls >= 1:
        averaged_dice = make_averaged(roll_dice, trials_count)
        average = averaged_dice(max_scoring_num_rolls, dice)
        if highest_average > average:
            None
        else:
            highest_average = average
            number_of_dice = max_scoring_num_rolls
